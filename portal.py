...
if check_password():
    ...
    # Botón de cerrar sesión centrado y pequeño debajo del banner
            ...
            if res_cli:
                ...
                if res_ano:
                    ...
                    if id_imp:
                        ...
                        else: st.info("La carpeta está vacía.")
                    else: st.error(f"⚠️ No encuentro la carpeta 'IMPUESTOS PRESENTADOS' en {a_bus}.")
